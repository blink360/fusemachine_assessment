    ...
    return new Promise(
        (resolve, reject) => {
            try {
                ...
                Object.keys(arrangedData).forEach((club) => {
                    //get last five matches win loss data
                    let last_five_match_win_loss = arrangedData[club].win.reverse().slice(0, 5);
                    //get last five matches draw data
                    let last_five_match_draw = arrangedData[club].draw.reverse().slice(0, 5);
                    ...
                    finalData[club] = {
                        matches_played: arrangedData[club].win.length,
